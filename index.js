...
function getReviewByRating(array, rating) {
  ...
  const fiveRating = array.filter((array) => array.rating === 5);
  const fourRating = array.filter((array) => array.rating >= rating && array.rating < 5);
  const threeRating = array.filter((array) => array.rating >= rating && array.rating < 4);
  const twoRating = array.filter((array) => array.rating >= rating && array.rating < 3);
  const oneRating = array.filter((array) => array.rating >= rating && array.rating < 2);
